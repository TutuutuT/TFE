...
onMounted(async () => {
  try {
    prompt.value = promptsValue.prompts[2];
...
<section class="w-full flex-col flex justify-center px-8 pt-32 bg-[#121212]" v-if="prompt">
  ...
  <div class="w-full flex justify-center px-8">
    <input class="min-w-[25vw] -mt-8 p-3 min-h-[40px] rounded-2xl border-2 border-white/40 max-w-3xl font-semibold z-20 bg-white/5 backdrop-blur-sm" v-model="Free" @input="updateFreePrompt" placeholder="Écrit ton idée ici" />
  </div>
  ...
  <div class="w-full flex justify-center px-8 pt-16">
    <input class="min-w-[20vw] -mt-8 mb-3 p-2 min-h-[40px] rounded-xl border-2 border-white/40 max-w-3xl z-20 bg-white/5 backdrop-blur-sm text-xs font-normal " v-model="Exclu" @input="updateExcluPrompt" placeholder="Exclus des éléments (arbres, montagnes, voitures...)" />
  </div>
