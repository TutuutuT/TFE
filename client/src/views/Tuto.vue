...
<template>
    <div class="absolute w-full h-full flex justify-center items-center bg-black/50 backdrop-blur-sm z-50">
        <div class="h-[25rem] w-[40rem] rounded-3xl border-2 border-white/40 bg-neutral-800 p-8">box tuto</div>
    </div>
